CLASS zcl_renting_load_data_jpvv DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_renting_load_data_jpvv IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_brands    TYPE TABLE OF zrent_brands_jp,
          lt_cars      TYPE TABLE OF zrent_cars_jpvv,
...
** BRANDS **
    ...
    DELETE FROM zrent_brands_jp.
    INSERT zrent_brands_jp FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_jp INTO TABLE
    @lt_brands.
    out->write( sy-dbcnt ).
...
** CARS**
    ...
    DELETE FROM zrent_cars_jpvv.
    INSERT zrent_cars_jpvv FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_jpvv INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).

    out->write( 'zrent_cars_jpvv data inserted successfully!').
** CUSTOMERS**
    lt_customers = VALUE #(
    ...
    DELETE FROM zrent_customersj.
    INSERT zrent_customersj FROM TABLE @lt_customers.
    SELECT * FROM zrent_customersj INTO TABLE
    @lt_customers.
    out->write( sy-dbcnt ).
